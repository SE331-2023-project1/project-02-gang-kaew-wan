...
public class InitApp implements ApplicationListener<ApplicationReadyEvent> {
        ...
        public void onApplicationEvent(ApplicationReadyEvent applicationReadyEvent) {
                ...
                Comment comment2 = Comment.builder().id(2L).message("Hello2").parent(comment1).receiver(teacherP)
                                .sender(studentP)
                                .edited(false).build();
                commentRepository.save(comment2);
                Reaction reaction = Reaction.builder().id(1L).emote("👍").reactable(comment2).build();
                reactionRepository.save(reaction);
                Announcement announcement = Announcement.builder().id(3L).message("Hello, students.")
                                ...
                                .teacher(teacherP)
                                .build();
                Announcement announcement2 = Announcement.builder().id(4L).message("Hello, students, again.")
